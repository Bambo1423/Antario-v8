...
{
	const char* yTypes[] = {
		"SLOW SPIN", "FAST SPIN", "SPIN_RANDOM", "JITTER", "CASUALJITTER", "RANDOM BACKJITTER", "BACKJITTER", "SIDE", "BACKWARDS", "FORWARDS", "LEFT", "RIGHT", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LOWERBODY", "LBYJITTER", "LBY ON GROUND", // safe
		...
		ImGui::BeginChild("HVH1", ImVec2(0, 0), true);
		{
			...
			ImGui::BeginChild("##ANTIAIM", ImVec2(0, 0), true);
			{
				...
				ImGui::NextColumn();
				{
					...
					{
						if ((*pGameRules) && (*pGameRules)->IsValveDS() && Settings::AntiAim::Yaw::typeFake >= AntiAimType_Y::LISP)
						{
					...
					{
						if ((*pGameRules) && (*pGameRules)->IsValveDS() && Settings::AntiAim::Yaw::type >= AntiAimType_Y::LISP)
						{
				...
				ImGui::NextColumn();
				{
					...
					{
						if ((*pGameRules) && (*pGameRules)->IsValveDS() && Settings::AntiAim::Pitch::type >= AntiAimType_X::STATIC_UP_FAKE)
						{
